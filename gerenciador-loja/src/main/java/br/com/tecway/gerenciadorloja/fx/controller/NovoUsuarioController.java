 ...
 * @since 24/06/2013
 */
public class NovoUsuarioController extends PrincipalController {

	private static final Logger LOGGER = LogManager.getLogger(NovoUsuarioController.class);
	...
	private UsuarioEntity criarUsuario() {
		...
		try {
			...
			usuario.setFlagAdministrador(false);
